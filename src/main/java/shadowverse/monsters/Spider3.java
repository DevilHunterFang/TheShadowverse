...
public class Spider3 extends CustomMonster {
    public static final String ID = "shadowverse:Spider3";
    ...
    public Spider3(float x, float y) {
        super(NAME, ID, AbstractDungeon.monsterHpRng.random(99, 99), -5.0F, 0.0F, 180.0F, 380.0F, "img/monsters/Spider/Spider3.png", x, y);
    ...
    public void usePreBattleAction() {
        ...
        addToBot(new ApplyPowerAction(this, this, new StrengthPower(this, AbstractDungeon.ascensionLevel >= 17 ? 5 : 3), AbstractDungeon.ascensionLevel >= 17 ? 5 : 3));
        addToBot(new ApplyPowerAction(this,this,new ThornsPower(this,AbstractDungeon.ascensionLevel >= 17 ? 5 : 3), AbstractDungeon.ascensionLevel >= 17 ? 5 : 3));
    }
