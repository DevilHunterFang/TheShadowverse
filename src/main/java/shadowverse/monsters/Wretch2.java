...
public class Wretch2 extends CustomMonster {
    public static final String ID = "shadowverse:Wretch2";
    ...
    public static final int HP_MAX = 46;
    ...
    public Wretch2(float x, float y) {
        super(NAME, ID, AbstractDungeon.monsterHpRng.random(40, 46), -5.0F, -20.0F, 145.0F, 400.0F, "img/monsters/Wretch/Wretch3.png", x, y);
