 ...
 public class EnemyDivinityParticleEffect extends AbstractGameEffect {
   ...
   public EnemyDivinityParticleEffect() {
     ...
     if (AbstractCharBoss.boss != null && 
       this.x > AbstractCharBoss.boss.hb.cX) {
   ...
   public void render(SpriteBatch sb) {
     ...
     if (AbstractCharBoss.boss != null) {
       ...
       sb.draw((TextureRegion)this.img, this.x, this.y + this.vY, this.img.packedWidth / 2.0F, this.img.packedHeight / 2.0F, this.img.packedWidth, this.img.packedHeight, this.scale, this.scale, this.rotation);
