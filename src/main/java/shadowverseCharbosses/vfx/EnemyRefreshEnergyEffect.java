   ...
   extends AbstractGameEffect
 {
   ...
   private float x = 1550.0F * Settings.scale + this.img.packedWidth / 2.0F;
   private float y = 720.0F * Settings.scale + this.img.packedHeight / 2.0F;
   ...
   public void render(SpriteBatch sb) {
     ...
     sb.draw((TextureRegion)this.img, this.x, this.y, this.img.packedWidth / 2.0F, this.img.packedHeight / 2.0F, this.img.packedWidth, this.img.packedHeight, this.scale * 1.5F, this.scale * 1.5F, this.rotation);
