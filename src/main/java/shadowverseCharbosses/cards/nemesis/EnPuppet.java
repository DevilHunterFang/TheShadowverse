...
public class EnPuppet extends AbstractBossCard {
    public static final String ID = "shadowverse:EnPuppet";

    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("shadowverse:Puppet");
    ...
    public AbstractCard makeCopy() {
        return (AbstractCard)new EnPuppet();
    }
}
